...
function WindowBody({ window, onSave, records, isSaving }: { window: WindowRecord; onSave: () => void; records: Array<{ docNo?: string; journalNo?: string; code?: string; legalName?: string; description?: string; status?: string; grandTotal?: number | string; totalDebit?: number | string }>; isSaving: boolean }) {
