-- GENERATED CODE — 3433INVT011.fmx
...
CREATE OR REPLACE PACKAGE BODY RB_F_3433INVT011_71304 IS
  g_status VARCHAR2(30) := 'NEW';

  PROCEDURE initialize(p_form_name IN VARCHAR2 DEFAULT '3433INVT011') IS
  BEGIN
    g_status := 'READY';
  ...
  BEGIN
    IF NOT is_valid(p_record_key) THEN
      RAISE_APPLICATION_ERROR(-20001, 'Validation failed for 3433INVT011');
    END IF;
