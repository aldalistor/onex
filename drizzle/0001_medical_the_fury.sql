...
CREATE TABLE `suppliers` (
	...
	CONSTRAINT `supplier_company_code` UNIQUE(`companyId`,`code`)
);
--> statement-breakpoint
...
CREATE TABLE `window_registry` (
	`id` int AUTO_INCREMENT NOT NULL,
	`screenNo` varchar(40) NOT NULL DEFAULT 'SYS-0000',
	`screenName` varchar(240) NOT NULL DEFAULT 'Legacy Window',
	`parentId` varchar(160),
	`systemNo` varchar(40) NOT NULL DEFAULT 'ONEX',
	`itemType` varchar(40) NOT NULL DEFAULT 'FORM',
	`formName` varchar(160) NOT NULL DEFAULT 'LEGACY.fmx',
	`displayOrder` int NOT NULL DEFAULT 0,
	`userPermission` varchar(120) NOT NULL DEFAULT 'ROLE_USER',
	`companyBranchPermission` varchar(160) NOT NULL DEFAULT 'COMPANY_BRANCH_SCOPE',
	`buildState` varchar(40) NOT NULL DEFAULT 'INDEXED',
	`compiledSize` int NOT NULL DEFAULT 0,
	`rebuildLevel` varchar(60) NOT NULL DEFAULT 'catalog_specification',
	`sourceStatus` varchar(80) NOT NULL DEFAULT 'FMB_PLL_not_found',
	`observedProcedures` int NOT NULL DEFAULT 0,
	`observedTriggers` int NOT NULL DEFAULT 0,
	`observedLibraries` int NOT NULL DEFAULT 0,
	`observedTableIndicators` int NOT NULL DEFAULT 0,
	`riskFlags` text,
	`specPath` varchar(240),
	`nextRequiredEvidence` varchar(240),
